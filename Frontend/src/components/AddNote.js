...
export default function AddNote(props) {
  ...
  <div className="form-group">
    ...
    name='title' aria-describedby="emailHelp" placeholder="Enter Title" onChange={onChange} minLength={5} required/>
  </div>
  <div className="form-group">
  ...
  <div className="form-group">
    ...
    <input type="text" className="form-control" id="tag" name='tag' value={note.tag} placeholder="Enter Description" onChange={onChange}/>
  </div>
